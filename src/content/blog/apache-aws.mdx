...
Irecently performed testing with an AWS Application Load Balancer (ALB) and needed to spin up three web servers in EC2 quickly. I decided to use the option of passing "User Data" and run Linux commands at launch to install Apache.
