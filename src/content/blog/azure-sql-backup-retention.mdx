...
I am currently working on an Azureproject that is focused on high availability and backup and restore operations. I have never been a "SQL" person or database admin, so this aspect at first appeared a little daunting.
